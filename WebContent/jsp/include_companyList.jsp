...
<%@ page import="com.qinghuan.dao.CompanyDAO,com.qinghuan.bean.Company,com.qinghuan.bean.Job" %>
...
<body class="tn-page-bg" >
  <div id="tn-content" >
     <!-- 招聘企业展示 -->
     <c:forEach items="${pagination.getPageData()}" var="company">
      <div class="tn-grid">
        <div class="tn-box tn-widget tn-widget-content tn-corner-all it-home-box">
          <div class="tn-box-content tn-widget-content tn-corner-all">
            ...
            <img src="../images/${company.companyPic}" width="990"> </a> </div>
            <!-- 招聘职位展示 -->
